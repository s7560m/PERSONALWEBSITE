    ...
    <v-container>
      <v-row>
        ...
        <v-col md="6"><v-card
          ...
          id="thisisme">
          <v-img src="static/coder.png"></v-img>
          <v-card-title class="main-card-text">My life as a programmer so far.</v-card-title>
          <v-card-text class="main-card-content-text">I've been programming since I was 11, where I'd build things like basic applications in Visual Basic 6.0 and games in Unity 3D. Ever since then I've gotten into fullstack development (React, Vue, Node, Express, Firebase, Mongo), machine learning (Google Cloud platform, AWS, tensorflow), android development and pretty much anything that intrigues me.</v-card-text>
          <v-card-text class="main-card-content-text">This section is currently a work in progress. But in the meantime you can check out my github <a href="https://github.com/s7560m">here</a></v-card-text>
        </v-card></v-col>
