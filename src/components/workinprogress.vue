    ...
    <v-container>
      <v-row>
        ...
        <v-col md="6"><v-card
          ...
          id="thisisme">
          <v-img src="static/yesssir.png"></v-img>
          <v-card-title class="main-card-text">Uh oh, this page doesn't exist yet!</v-card-title>
          <v-card-text>This page is currently under development. Click that big red button below to go back to the main page.</v-card-text>
          <v-card-title>
          <v-btn class="button" x-large color="red darken-3" dark outlined @click="gotolink()">CLICK HERE</v-btn>
          </v-card-title>
        </v-card></v-col>
